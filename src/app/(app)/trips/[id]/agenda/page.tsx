            ...
            <div key={day.id} className="overflow-hidden rounded-2xl border border-slate-200 bg-white">
              ...
              {isOpen && (
                <div className="border-t border-slate-100 px-4 py-3">
                  ...
                  {itens.length === 0 && (
                    <p className="text-[12px] text-slate-400">Nenhum compromisso nesta data ainda.</p>
                  )}
                  ...
                  <ul className="flex flex-col gap-2">
                    {itens.map((item) => (
                      <li
                        key={item.id}
                        className="flex items-start justify-between gap-2 rounded-lg border border-slate-100 px-3 py-2 text-[12px]"
                      >
                        <div className="min-w-0">
                          <p className="font-medium text-slate-800">
                            {item.horario} - {item.descricao}
                          </p>
                          <div className="mt-0.5 flex flex-wrap gap-3 text-[10px]">
                            {item.url && (
                              <a
                                href={item.url}
                                target="_blank"
                        ...
                        <div className="flex shrink-0 items-center gap-3 text-[10px] font-medium">
                          <button
                            type="button"
                  ...
                  <button
                    ...
                    className="mt-3 text-[10px] font-medium text-blue-600 hover:text-blue-800"
                  >
